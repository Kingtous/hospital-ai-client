...
class BarChart extends StatefulWidget {
  ...
  final LocalBrnProgressBarChartSelectCallback? barChartSelectCallback;
...
class BrnProgressBarChartState extends State<BarChart> {
  LocalBrnProgressBarItem? _selectedBarItem;

  Size _chartSize() {
    int barBundleCount = widget.barBundleList.length;
    int numberOfBars = widget.barBundleList[0].barList.length;
    if (LocalBarChartStyle.horizontal == widget.barChartStyle) {
  ...
  void _clearSelectedBarItem(BarChart oldWidget) {
      ...
      for (int bundleIndex = 0; bundleIndex < bundleCount; bundleIndex++) {
        ...
        if (bundle.barList.length == oldBundle.barList.length) {
          ...
          for (int barIndex = 0; barIndex < barCount; barIndex++) {
            LocalBrnProgressBarItem barItem = bundle.barList[barIndex];
            LocalBrnProgressBarItem oldBarItem = oldBundle.barList[barIndex];
